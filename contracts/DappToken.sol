...
contract DappToken {
    string public name="Dapp Token";  // name of the token
    string public symbol = "DAPP"; // symbol of the token
    ...
    uint public totalSupply; // Here we provide total supply of our token
    ...
    constructor() {
        ...
        totalSupply = 200000; // total supply as 10000
    ...
    function allowance(address tokenOwner, address spender) public view returns(uint noOfToken) {
